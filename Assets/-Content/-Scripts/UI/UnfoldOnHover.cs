...
public class UnfoldOnHover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
		_rtParent.DOLocalMoveY(_rtParent.sizeDelta.y * _deltaSizePercentageUnfolded, _moveDuration).SetEase(Ease.OutBack);
    }

    public void OnPointerExit(PointerEventData eventData)
    {
		_rtParent.DOLocalMoveY(0, _moveDuration).SetEase(Ease.OutBack);
    }
}